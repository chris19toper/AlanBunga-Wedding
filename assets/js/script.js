...
//countdown wedding
var countdownDate = new Date("Nov 15, 2025 15:00:00").getTime()
...
var x = setInterval(function () {
  ...
  if (distance < 0) {
    clearInterval(x)
    document.getElementById('countdown-wedding').innerHTML = "<span class='text-center p-3 rounded text-light n-2'><h2>Sudah Dimulai</h2></span>"
  }
}, 1000)
...
function copyText(el) 
{
  ...
  jQuery(el).text('Berhasil di Salin')
